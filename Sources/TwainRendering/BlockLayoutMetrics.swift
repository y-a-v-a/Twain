...
public struct BlockLayoutMetrics {
    ...
    public var pointsPerLineUnit: CGFloat
    ...
    public var headingDividerMaxLevel: Int
    /// VStack spacing between heading label and its divider.
    public var headingDividerGap: CGFloat
    /// Approximate rendered thickness of the divider under h1/h2.
    public var headingDividerThickness: CGFloat

    public var paragraphBottomSpacing: CGFloat

    public var codeBlockPadding: CGFloat
    public var codeBlockBottomSpacing: CGFloat
    public var codeBlockFontScale: CGFloat
    public var codeBlockLineSpacingScale: CGFloat

    public var tableBottomSpacing: CGFloat
    /// Inside the table, outside the cells (`.padding(1)` in `ThemedTableStyle`).
    public var tableInnerPadding: CGFloat
    /// Outermost table border.
    public var tableOuterBorderWidth: CGFloat
    /// Gap between cells in both directions (`tableCellSpacing`).
    public var tableCellSpacing: CGFloat
    /// Vertical padding applied inside each cell.
    public var tableCellVerticalPadding: CGFloat
    /// Horizontal padding applied inside each cell.
    public var tableCellHorizontalPadding: CGFloat

    public var thematicBreakTopSpacing: CGFloat
    public var thematicBreakBottomSpacing: CGFloat
    public var thematicBreakRuleFontScale: CGFloat
    ...
    public var averageCharacterWidthScale: CGFloat
    ...
    public func charactersPerLine(fontScale: CGFloat = 1) -> CGFloat {
...
extension Theme {
    ...
    public var styleLayout: BlockLayoutMetrics { blockLayout(fontSize: 16) }

    public func blockLayout(fontSize: CGFloat, contentWidth: CGFloat = 0) -> BlockLayoutMetrics {
